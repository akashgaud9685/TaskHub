...
<div class="text-center animate-fade-up stagger-1"><p class="text-4xl font-bold text-purple-400">10+</p><p class="text-sm text-slate-400 mt-1">Features</p></div>
<div class="text-center animate-fade-up stagger-2"><p class="text-4xl font-bold text-blue-400">50+</p><p class="text-sm text-slate-400 mt-1">Active Users</p></div>
<div class="text-center animate-fade-up stagger-3"><p class="text-4xl font-bold text-emerald-400">100+</p><p class="text-sm text-slate-400 mt-1">Tasks Managed</p></div>
...
<div><div class="flex items-center gap-2 mb-4"><div class="w-6 h-6 rounded bg-purple-600 flex items-center justify-center text-xs font-bold">T</div><span class="font-bold"><span class="text-purple-400">Task</span>Hub</span></div><p class="text-sm text-slate-500">Streamline your workflow, manage tasks, and grow your business.</p></div>
<div><h4 class="font-semibold mb-4 text-sm uppercase tracking-wider text-slate-400">Product</h4><ul class="space-y-2 text-sm text-slate-500"><li><a href="features.php" class="hover:text-white transition">Features</a></li><li><a href="register.php" class="hover:text-white transition">Register</a></li></ul></div>
...
<div class="border-t border-white/5 pt-8 text-center text-xs text-slate-600">TaskHub &mdash; Developed by <span class="text-purple-400">Aakash Gaud</span> &copy; 2026 All Rights Reserved</div>
</div>
</footer>
</body>
</html>
